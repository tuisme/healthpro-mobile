...
class _MyHomePageState extends State<DirectDetailPage> {
  ...
  Future _getThingsOnStartup() async {
    ...
    var directUrl = 'https://maps.googleapis.com/maps/api/directions/json?origin=' + _current.latitude.toString() + ', ' + _current.longitude.toString() + '&destination=' + _des.split(",")[0] + ',' + _des.split(",")[1] + '&key=KEY';
