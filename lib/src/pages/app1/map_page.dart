...
class _MyHomePageState extends State<MapPage> {
  ...
  void getCurrentLocation() async {
    ...
    var url = 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=' + _location.latitude.toString() + ', ' + _location.longitude.toString() + '&radius=150000&type=hospital&key=KEY';
    print(url);
    try {
      final response =
      await http.get(url);
